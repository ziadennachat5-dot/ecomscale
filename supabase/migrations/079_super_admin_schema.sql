-- ============================================================
-- SUPER ADMIN PANEL - COMPLETE DATABASE SCHEMA
-- ============================================================
...
CREATE INDEX IF NOT EXISTS announcements_start_end_idx ON announcements(start_date, end_date);
...
CREATE INDEX IF NOT EXISTS error_logs_workspace_id_idx ON error_logs(workspace_id);
...
CREATE INDEX IF NOT EXISTS security_logs_blocked_idx ON security_logs(blocked);
...
CREATE INDEX IF NOT EXISTS api_usage_logs_workspace_id_idx ON api_usage_logs(workspace_id);
...
CREATE INDEX IF NOT EXISTS database_backups_type_idx ON database_backups(type);
CREATE INDEX IF NOT EXISTS database_backups_status_idx ON database_backups(status);
CREATE INDEX IF NOT EXISTS database_backups_created_at_idx ON database_backups(created_at DESC);
...
CREATE INDEX IF NOT EXISTS workspace_exports_workspace_id_idx ON workspace_exports(workspace_id);
CREATE INDEX IF NOT EXISTS workspace_exports_status_idx ON workspace_exports(status);
CREATE INDEX IF NOT EXISTS workspace_exports_created_at_idx ON workspace_exports(created_at DESC);
